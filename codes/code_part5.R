# This code replicate Figure 2 and Figure 3 in the manuscript usfing geom_smooth based on primary study's parameter
# and functiona form to show the variation in elasctity measures depend on proximity to lakeshore
