# This code replicate The Table 2 in manuscript. Where we summarize the unweighted mean and 
# mean elasticity estimations from random effect models for the distance bins we use in
# our benefit transfer exercise 
